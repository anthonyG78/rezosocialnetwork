...
class Access {
    ...
    static getUser(user, targetUserId) {
        return new Promise((resolve, reject) => {
            if (this.hasPrivilege(user.level) || user._id == targetUserId) {
                ...
                // console.log('Acces.getUser()', user._id, targetUserId);
                return UserModel.userExists(targetUserId)
                    .then(() => {
    ...
    static createPostComment(user, postId) {
        return this.deletePost(user, postId);
    }
